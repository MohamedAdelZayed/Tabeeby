      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-6 border-b pt-3.5 sm:pt-0 border-gray-200 dark:border-gray-700">
          ...
          <button
            ...
            className={`relative pb-2 text-sm font-medium cursor-pointer transition-all duration-300 ${activeTab === "upcoming"
              ? "text-[#5F6FFF]"
          ...
          >
            {t("upcoming")}
            <span
              className={`absolute bottom-0 left-0 h-0.5 bg-[#5F6FFF] transition-all duration-300 ${activeTab === "upcoming" ? "w-full" : "w-0"
                }`}
            ></span>
          </button>
          ...
          <button
            ...
            className={`relative pb-2 text-sm font-medium cursor-pointer transition-all duration-300 ${activeTab === "past"
              ? "text-[#5F6FFF]"
              : "text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200"
              }`}
          >
            {t("past")}
            <span
              className={`absolute bottom-0 left-0 h-0.5 bg-[#5F6FFF] transition-all duration-300 ${activeTab === "past" ? "w-full" : "w-0"
                }`}
            ></span>
          </button>
            ...
            >
              ...
              <div className="flex-1 space-y-1">
                ...
                <div className="pt-3 text-sm">
                  ...
                  <span
                    className={`text-gray-500 dark:text-gray-400 ml-2 ${locale === "ar" ? "text-right" : "text-left inline"
                      }`}
                  >
                    {formatDateTime(
              ...
              <div className="flex flex-col sm:flex-row lg:flex-col gap-3 w-full lg:w-44">
                {/* لو الموعد في الماضي (Past Tab) */}
                {activeTab === "past" ? (
                  <div className={`w-full py-2.5 px-2 rounded-lg text-[12px] sm:text-sm font-medium text-center border transition-all ${item.is_paid
                    ...
                    {item.is_paid ? (
                      <span className="whitespace-nowrap">
                        {t("completed")} {locale === "ar" ? "(مدفوع)" : "(Paid)"}
                      </span>
                    ) : (
                      <span className="whitespace-nowrap">
                        {t("expired")} {locale === "ar" ? "(غير مدفوع)" : "(Unpaid)"}
                      </span>
                    )}
                  </div>
